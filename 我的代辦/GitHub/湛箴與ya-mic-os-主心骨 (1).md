...
https://github.com/ProtonMail/WebClients?tab=GPL-3.0-1-ov-file
...
2. 爲什麽是智能體之間交流，因爲第一步就是人類和智能體交流好了，讓智能體去判斷需要跨行業的經驗的話，讓智能體自己去找智能體
3. 每個智能體對當前議題只能發一條訊息
4. 等所有參會者都發完才能發下一條
5. 會議結束自動生成結構化共識報告
6. 也不用報告，就是流程圖很多智能體一起聊，我的（用戶）智能體為主弄好流程圖就好了，人類隨時可以暫停
